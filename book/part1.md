...
> *"The Old Builders are gone. Their farms went wild, their lanterns died,
> and the night crept in where light once stood. The world has been
> overtaken — by shadow, by chaos, by the creatures that own the dark.
> But they left one thing behind: a map, a compass, and a commission.
> You are the missionary of the block. Your task is not merely to survive.
> Your task is to take the world back — one mission at a time."*
>
...
The book contains **fifteen missions**, organized in three tiers of
difficulty:

| Tier | Missions | Difficulty | What you will do |
|---|---|---|---|
...
Every mission follows the same format:
...
- **COORDINATES** — exactly where in the world the mission takes place
- **THE PLAN** — the step-by-step execution
- **SUCCESS CHECKLIST** — how you will know the mission is complete
- **MISSIONARY NOTE** — a short reflection from the field

### Setting Up the World

Use these settings so the coordinates in this book match your world:

- **World name:** Overtaken
- **Seed:** `OVERTAKEN`
- **Game mode:** Survival
- **Difficulty:** Normal (Easy if you are new, Hard if you are a veteran)
- **World type:** Default
- **Cheats:** Off. A missionary earns every block.

### The Rules of the Mission Field

1. No creative mode. If a mission says collect 64 iron ore, you mine it.
2. No teleporting. You walk, you climb, you swim — or you build the thing
   that carries you.
3. If you die, you return and finish. The world does not reset for you.
4. A mission is only complete when every item on the success checklist is
   checked.
...
Every mission in this book gives you exact coordinates. Before you take a
single step, learn to read them. This is the single most important skill
in the book.

**The three numbers are always in the same order: X, Y, Z.**

| Axis | Meaning | Positive (+) | Negative (−) |
|---|---|---|---|
| **X** | East / West | East | West |
| **Y** | Up / Down (height) | Up | Down |
| **Z** | South / North | South | North |

**Sea level is Y = 63.** This is your anchor. If a mission says Y = 64, you
are one block above sea level — standing on the surface. If it says Y = 16,
you are 47 blocks underground, near the diamond layer. If it says Y = 150,
you are building in the sky.

Here is how to read a pair of camps from an old mission log:
...
- Camp 2 is **4 blocks west** of Camp 1 (X went −185 → −189, toward negative = west)
- Camp 2 is **56 blocks lower** (Y went 61 → 5 — that is a deep tunnel; Camp 1 sits just below the surface, Camp 2 crouches just above bedrock)
- Camp 2 is **29 blocks north** of Camp 1 (Z went −190 → −161, toward positive = south... wait — −161 is *more* positive than −190, so Camp 2 is actually **29 blocks south**)

**Rule of thumb:**

- **X or Z changes → you are moving sideways** (north / south / east / west)
- **Y changes → you are moving up or down**
- Y is your floor number. To find a place again: match X and Z first, then climb or dig until Y matches too.

**The one exception:** the Nether. Coordinates there are roughly one-eighth
of the Overworld. This book gives you both sets when a mission crosses over.

---

# TIER I — EASY

*The first five missions stay near the surface. They teach you the rhythm
of the missionary life: gather, build, light, plant, descend. Do not skip
them. Even a veteran must learn the ground they stand on.*

---

## MISSION 1 — THE FIRST FOUNDATION

**Difficulty: Easy**

### Mission Briefing

You stand at the world's heart — spawn, at (0, 63, 0). The grass is tall,
the trees are wild, and nothing here belongs to anyone. The Old Builders
left no shelter. Before you can reclaim anything, you must have a place
to be safe when the sun goes down. A missionary without a home is a
missionary who does not last the night.

### Objective

Build a **7×7 wooden house** at the mission plot, with a door, a bed, four
glass windows, and twelve torches. Sleep in it before dawn.
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Plot corner (southwest) | 24 | 64 | 12 |
| Plot corner (northeast) | 30 | 64 | 18 |
| Front wall | 24 | 64–67 | 12–18 |
| Door position | 26 | 64 | 12 |
| Roof level | 24–30 | 68 | 12–18 |

The house occupies X 24–30 and Z 12–18 — a 7×7 footprint with a 5×5
interior. Walls rise from Y 64 to Y 67. The roof caps it at Y 68.

### The Plan

1. **Gather the wood.** Fell oak trees until you have 64 logs. Turn them
   into planks: 64 logs = 256 planks. You need 160 for the build and 96
   for crafting tools and torches.
2. **Mark the plot.** Stand at (24, 64, 12). Lay a row of cobblestone
   along Z 12 from X 24 to X 30. This is your front wall's foundation.
3. **Raise the walls.** Build the front wall at Z 12 from Y 64 to Y 67.
   Leave a two-block gap at (26–27, 64, 12) for the door. Build the back
   wall at Z 18, and the side walls at X 24 and X 30.
4. **Add the windows.** Place glass at (25, 66, 12), (27, 66, 12),
   (29, 66, 12) on the front, and one more on the back wall at
   (27, 66, 18). Four windows, four directions of light.
5. **Roof it.** Cap the top at Y 68 with oak planks, all the way across.
6. **Furnish.** Place the door in the gap. Put the bed against the back
   wall at (28, 64, 17). Craft and place a crafting table and a furnace.
7. **Light it.** Place torches: one in each interior corner at Y 65, two
   on the front wall outside, two on the back, and four around the roof
   edge. Twelve torches total.
8. **Sleep.** Right-click the bed as night falls. This sets your spawn
   point — the first claim in your new territory.

### Success Checklist

- [ ] Walls complete from Y 64 to Y 67 with no gaps
- [ ] Door closes and opens
- [ ] Four glass windows placed
- [ ] Bed placed and slept in
- [ ] Twelve torches burning
- [ ] No hostile mobs inside the house at dawn

### Missionary Note

*A house is the first act of claiming. Before you can bring light to the
world, you need a place to keep your own. The Old Builders forgot this,
and their light went out. Build small, build solid, build light — then
move outward. The world is taken back one foundation at a time.*

---

## MISSION 2 — THE BREAD BASKET

**Difficulty: Easy**

### Mission Briefing

A missionary marches on bread. The wild grass around the camp carries
wheat seeds — the Old Builders' farms are gone, but their grain survives
in the tall grass, waiting to be gathered and planted again. This mission
turns wild seed into a working farm: the first food supply of the
reclamation.

### Objective

Build a **fenced 9×9 wheat farm** at the mission field, plant **32 wheat
seeds**, and harvest **32 wheat**. One water source must water the whole
field.
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Field corner (northwest) | −45 | 63 | 80 |
| Field corner (southeast) | −37 | 63 | 88 |
| Water channel | −41 | 63 | 84 |
| Fence perimeter | −46 to −36 | 63 | 79 to 89 |
| Gate | −45 | 63 | 84 |

The field spans X −45 to −37 and Z 80 to 88. A single water source at
(−41, 63, 84) sits in the middle, hydrating all 80 farmland blocks around
it.

### The Plan

1. **Collect the seeds.** Break tall grass until you have 32 wheat seeds.
   (You may find more — keep them; you will need them.)
2. **Till the field.** With the hoe, till every block in the 9×9 area
   except the center block at (−41, 63, 84).
3. **Water it.** Use the water bucket at the center. The water will flow
   one block in every direction, hydrating the entire field. Cover the
   source with a slab if you want to walk across without falling in.
4. **Plant.** Plant all 32 seeds in the tilled soil. If you have more
   seeds, plant them too — a full field is a richer harvest.
5. **Fence it.** Ring the field with fence: 28 pieces, one block outside
   the tilled edge. Place the fence gate on the west side at
   (−45, 63, 84) so the field stays open to you and closed to mobs.
6. **Light the edges.** Place 8 torches on the fence corners and midpoint
   posts so no mobs spawn on or near the field at night.
7. **Wait and harvest.** Wheat grows in stages. When it is golden and
   tall, break it and collect the wheat. You need 32 in your inventory
   to complete the mission — but replant the seeds you drop. A bread
   basket is a cycle, not a one-time harvest.

### Success Checklist

- [ ] 32 wheat harvested and in inventory
- [ ] Field fully fenced with a working gate
- [ ] One water source hydrating the field
- [ ] 8 torches placed around the perimeter
- [ ] Seeds replanted for the next harvest

### Missionary Note

*The world will not feed you because you ask. It feeds you because you
work. The Old Builders' fields were overtaken by grass the moment they
stopped tending them — that is the law of this world: whatever you do not
tend, the wild takes back. A farm is a promise you renew every day.*

---

## MISSION 3 — THE LANTERN ROAD

**Difficulty: Easy**

### Mission Briefing

The way from spawn to the eastern ridge is dark, and in the dark the
world's creatures hunt. The Old Builders believed roads were for carts.
The missionary knows better: roads are for light. A lit road is a line
drawn through the night, a claim staked in torchlight from horizon to
horizon.

### Objective

Light a **torch path** from spawn (0, 63, 0) to the eastern ridge at
(100, 64, 100), placing **32 torches** along the route. Then build a
**10-block-high torch tower** at the ridge and light its crown.
...
*(48 coal + 48 sticks = 48 torches. You will place 32 on the road, keep
the rest for the tower and spares.)*
...
|---|---|---|---|
| Path start | 0 | 63 | 0 |
| Path end (ridge) | 100 | 64 | 100 |
| Torch spacing | every 3 blocks along the diagonal | — | — |
| Tower base | 100 | 64 | 100 |
| Tower crown | 100 | 74 | 100 |

The path runs diagonally northeast: X and Z rise together, 0 → 100. Place
a torch every 4 blocks: (4, 63, 4), (8, 63, 8), (12, 63, 12), and so on
until (100, 64, 100).

### The Plan

1. **Gather fuel and light.** Mine 48 coal. Craft 48 sticks, then 48
   torches. (You will need more later in the book — this is your first
   torch run; it will not be your last.)
2. **Pave the stepping stones.** Lay cobblestone and slabs in short
   stretches along the diagonal so the route is walkable. You do not
   need a full road — a missionary builds for light, not for carts.
3. **Plant the torches.** Starting at (3, 63, 3), place a torch roughly
   every three blocks along the diagonal — about 32 torches over the
   run. Where the ground rises, put the torch on a cobblestone stub so
   it never sits below your eye line.
4. **Reach the ridge.** The path ends at (100, 64, 100). From here you
   can see back to spawn — which is exactly the point.
5. **Build the tower.** At (100, 64, 100), stack cobblestone to Y 74.
   Place a torch on top of the crown and four more around the sides at
   Y 73. This is the Lantern of the East: the first landmark of the
   reclamation.
6. **Check the gaps.** Walk the path at night. No stretch of darkness may
   exceed 8 blocks. Add torches where the light pools thin.

### Success Checklist

- [ ] 32 torches placed along the path at roughly 4-block intervals
- [ ] Path visible end to end at night from spawn
- [ ] Tower at (100, 64, 100) standing 10 blocks high
- [ ] Tower crown lit with 5 torches
- [ ] No dark gap longer than 8 blocks anywhere on the route

### Missionary Note

*Light is the first weapon of the missionary. Mobs do not respect your
sword until they fear your torches. Every torch you plant is a small
sermon: this ground is claimed, this ground is watched, this ground
belongs to the light again.*

---

## MISSION 4 — THE WATCHTOWER

**Difficulty: Easy**

### Mission Briefing

To the northwest, the forest opens into a plain that the Old Builders
called the Quiet Field. It is not quiet anymore — it is overtaken. From
the rise at (−120, −40) you can see the whole plain, and something else:
the first true test of a builder. A tower that can see is a tower that
can warn. The reclamation needs eyes.

### Objective

Build a **12-block-high watchtower** at the mission site, with a working
ladder, a fenced observation platform, and **16 torches**. From the top,
you must be able to see the Lantern of the East at (100, 64, 100).
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Tower footprint (southwest corner) | −120 | 64 | −40 |
| Tower footprint (northeast corner) | −114 | 64 | −34 |
| Base height | −120 to −114 | 64–65 | −40 to −34 |
| Wall tops | −120 to −114 | 76 | −40 to −34 |
| Observation platform | −119 to −115 | 76 | −39 to −35 |
| Ladder (north face) | −117 | 64–75 | −40 |
| Windows | −120 | 70 | −37, and −117 | 70 | −40 |

The tower is a 7×7 hollow shaft. Its walls rise from Y 64 to Y 76 —
12 blocks of stone against the sky.

### The Plan

1. **Gather stone.** Mine 192 cobblestone. A nearby hill should cover
   most of it.
2. **Lay the base.** Build the 7×7 footprint two blocks high (Y 64–65).
   Leave the inside hollow.
3. **Raise the shaft.** From the base, raise the four walls to Y 76 —
   ten more blocks. Leave the ladder shaft open on the north face at
   (−117, Z −40).
4. **Windows.** At Y 70, place glass at (−120, 70, −37) on the west wall
   and (−117, 70, −40) on the north wall. Small windows, watchful eyes.
5. **The ladder.** Run ladders up the north face shaft from Y 64 to
   Y 75 — 24 ladders, no gaps. Test the climb.
6. **The platform.** At Y 76, floor the top with oak planks. Ring it
   with fence. Place torches in the four corners and along the fence —
   16 torches total on the tower.
7. **Look east.** From the platform, face (100, 64, 100). If the night
   is clear, the Lantern of the East answers your light with its own.

### Success Checklist

- [ ] Tower stands 12 blocks from base to platform
- [ ] Ladder climbs the full height without gaps
- [ ] Platform floored and fully fenced
- [ ] 16 torches placed
- [ ] Lantern of the East visible from the top

### Missionary Note

*The Watchtower teaches the second law of the mission field: see before
you are seen. The creatures of the overtaken world ambush what they can
surprise. A tower does not fight for you — it sees for you, and seeing
is half the battle. Raise your eyes, and the night loses its advantage.*

---

## MISSION 5 — THE FIRST DESCENT

**Difficulty: Easy**

### Mission Briefing

The surface can feed you and shelter you, but it cannot arm you. Iron
waits below — and below is where the world keeps its oldest secrets and
its darkest rooms. Every missionary must learn to go down. This mission
teaches the descent: a proper shaft, a proper ladder, a proper light
discipline, and the first real ore of the reclamation.

### Objective

Dig a **1×2 vertical shaft** at the mission site down to **Y 16**, then
branch-mine the tunnel at Y 16 and collect **32 iron ore**.
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Shaft mouth | 50 | 63 | −70 |
| Shaft bottom | 50 | 16 | −70 |
| Branch tunnel | 50 → 70 | 16 | −70 |
| Side branches | 50 → 70 | 16 | −72 and −68 |

The shaft drops 47 blocks straight down from (50, 63, −70) to
(50, 16, −70). At the bottom, a branch tunnel runs east from X 50 to
X 70 at Y 16, with side branches at Z −72 and Z −68.

### The Plan

1. **Prepare.** Craft 3 stone pickaxes (48 cobblestone + 3 sticks × 3),
   40 ladders, and 32 torches. Eat before you descend — mining is hungry
   work.
2. **Dig the shaft.** At (50, 63, −70), dig a 1×2 hole straight down.
   Place ladders on one side of the shaft as you go, every block, no
   gaps. Torch the shaft every 8 blocks as you descend.
3. **Follow the floor.** When your Y readout says 16, stop. You are at
   the mission floor — deep enough for iron in abundance, safe from lava
   lakes above the diamond layer.
4. **Branch-mine.** Dig the main tunnel east from (50, 16, −70) to
   (70, 16, −70). Then dig side branches two blocks apart at Z −72 and
   Z −68, 20 blocks long each. This pattern exposes the most ore for the
   least digging.
5. **Collect the iron.** Mine every iron ore block you find with your
   stone pickaxe. Do not smelt yet — this mission is about gathering.
   You need 32 blocks of iron ore in your inventory.
6. **Light as you go.** Torch every tunnel every 8 blocks. A dark tunnel
   is a mob nursery. You are a missionary of light — even underground.
7. **Come back up.** Climb the ladder. Check your Y as you rise: 20, 30,
   40, 50, 60 — the world's floors rolling past like stairs.

### Success Checklist

- [ ] Shaft bottom reached at Y 16
- [ ] Ladders placed the full 47-block descent
- [ ] Branch tunnels dug to spec
- [ ] 32 iron ore in inventory
- [ ] Every tunnel lit, no spawns in the shaft

### Missionary Note

*The descent is the third lesson: the world's wealth is buried, and so
is its danger. The Old Builders mined greedily and left their shafts
dark; the creatures of the deep moved in behind them. When you go down,
light everything and leave nothing behind. A clean mine is a claim that
stays claimed.*
...
*The middle five missions take you farther from spawn and deeper into the
world. You will carve rooms out of the earth, run iron through fire,
bridge a chasm, cross into the Nether, and make redstone obey. The easy
days are over; the great work begins.*

---

## MISSION 6 — THE UNDERGROUND STRONGROOM

**Difficulty: Normal**

### Mission Briefing

The surface is safe now — your house stands, your farm feeds you, your
tower watches. But a missionary's treasure should not sit where every
wandering eye can see it. Two hundred blocks east and three hundred
south, a hill hides a secret: the perfect place for a strongroom.
You will cut a staircase into the hill and carve a home out of the
earth's bones.

### Objective

Cut a **staircase tunnel** from the surface at (200, 63, 300) down to
**(200, 30, 300)**, then carve a **15×15×4 room** around that point and
furnish it with 16 chests, 8 furnaces, 4 crafting tables, and a bed.
...
*(The iron ingots are for the door hinges and the furnace upgrades — a
strongroom without iron is a pantry.)*

### Coordinates

| Landmark | X | Y | Z |
|---|---|---|---|
| Tunnel mouth (surface) | 200 | 63 | 300 |
| Staircase | 200 | 63 → 30 | 300 |
| Room floor (southwest corner) | 193 | 30 | 293 |
| Room floor (northeast corner) | 207 | 30 | 307 |
| Ceiling | 193–207 | 34 | 293–307 |

The staircase drops 33 blocks straight down the Z axis at X 200. At
Y 30, the room opens: X 193–207, Z 293–307 — a 15×15 floor with a
4-block ceiling height.

### The Plan

1. **Mark the mouth.** At (200, 63, 300) on the hillside, dig a 2-wide
   entrance.
2. **Cut the staircase.** Dig down in a straight run, 2 blocks wide, with
   a step down every block. Torch both walls every 8 blocks. Check your
   Y as you go: 55, 45, 35 — and stop at 30.
3. **Carve the room.** At Y 30, expand in all directions to the corners
   (193, 30, 293) and (207, 30, 307). Cut the ceiling flat at Y 34.
4. **Seal and light.** Line the walls with torches on every pillar face —
   a 15×15 room needs about 40 torches to stay spawn-proof. Place the
   rest along the staircase.
5. **Furnish.** Chests against the north and south walls — 8 per wall,
   16 total. Furnaces along the east wall — 8 of them. Crafting tables
   in the four corners. Bed against the west wall.
6. **Doors.** Place a door at the tunnel mouth and a second at the room
   entrance. The strongroom is yours; the world stays outside.
7. **Inventory.** Fill the chests with everything you have gathered so
   far — iron ore from Mission 5, wheat from Mission 2, spare cobble and
   coal. A missionary who loses his stores loses his momentum.

### Success Checklist

- [ ] Staircase complete from Y 63 to Y 30, fully lit
- [ ] Room carved to exact 15×15×4 dimensions
- [ ] 16 chests placed
- [ ] 8 furnaces placed
- [ ] 4 crafting tables placed
- [ ] Bed placed; no mob spawns anywhere in the room

### Missionary Note

*The strongroom is the fourth lesson: what you gather, you must guard.
The Old Builders piled their wealth in the open and it was scattered in
a single night. Bury what you love, light what you bury, and the world
will have to work to take it from you.*

---

## MISSION 7 — THE IRONWORKS

**Difficulty: Normal**

### Mission Briefing

Your chests are full of iron ore, but ore is only a promise. Iron becomes
useful only when it passes through fire. Three hundred fifty blocks east
of spawn, an outcrop of stone at (350, 64, 100) is the natural site for
the Ironworks — a row of furnaces that will turn the promise of ore into
the currency of the reclamation: iron ingots.

### Objective

Build an **8-furnace smelting works** at the mission site with a
**hopper-fed chest system**, then smelt **64 iron ingots** and bank them
in the chest.
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Furnace row | 350 → 357 | 64 | 100 |
| Hopper row (below) | 350 → 357 | 63 | 100 |
| Collection chests | 352–353 | 62 | 102–103 |

Eight furnaces sit in a row along Z 100, X 350 through 357. Each furnace
feeds a hopper directly beneath it at Y 63; the hoppers feed chests at
(352–353, 62, 102–103).

### The Plan

1. **Feed the mission.** Mine 64 iron ore if your stores are short —
   follow the Mission 5 branch-mine pattern in fresh ground. You also
   need 64 coal: any coal seam at Y 16–40 will do.
2. **Build the works.** Place 8 furnaces in a row: (350, 64, 100)
   through (357, 64, 100).
3. **Plumb the hoppers.** Dig out the blocks beneath each furnace
   (Y 63) and place a hopper there, pointed down. Dig a small channel at
   Y 62 leading to the chest position at (352–353, 62, 102–103). Place
   the four chests.
4. **Wire the flow.** Each hopper must point toward the next until the
   line reaches the chests. Sneak-place the hoppers facing the correct
   direction — this is the fiddliest step, and the most rewarding.
5. **Fire the works.** Load each furnace with 8 coal and 8 iron ore.
   Light them. As each ingot smelts, the hopper below catches it and
   carries it to the chest.
6. **Bank the ingots.** Run the works until 64 iron ingots sit in the
   chest. Count them. When the count is right, the mission is done.

### Success Checklist

- [ ] 8 furnaces in a row at the mission coordinates
- [ ] 8 hoppers connected, all feeding the chest line
- [ ] 4 chests placed and reachable
- [ ] 64 iron ingots banked in the chest
- [ ] Works lit and safe to operate at night

### Missionary Note

*Ore is potential; ingot is power. The Ironworks teaches the fifth
lesson: build systems, not just things. The Old Builders smelted one
furnace at a time and spent their days tending fires. You will build a
machine that tends itself while you do the next mission. Systems are how
a single missionary reclaims a world.*

---

## MISSION 8 — THE CHASM BRIDGE

**Difficulty: Normal**

### Mission Briefing

Four hundred blocks east of spawn, the land tears open. A ravine — the
Old Builders called it the God-Split — runs for hundreds of blocks,
darker than a wound, deeper than a well. The eastern lands beyond it
hold the Nether gate site, but the ravine blocks the way. The creatures
below own the dark. The missionary's answer is not to go around. The
missionary's answer is to build across.

### Objective

Bridge the ravine from the **west lip at (400, 70, −200)** to the
**east lip at (470, 70, −180)**, with a 2-wide plank deck, fences on
both sides, and 16 torches. Cross it safely.
...
| West lip | 400 | 70 | −200 |
| East lip | 470 | 70 | −180 |
| Deck | 400 → 470 | 70 | −200 → −180 |
| Torch spacing | every 8 blocks along the deck | — | — |

The ravine runs roughly southwest–northeast. The bridge crosses at
Y 70, 7 blocks above the surrounding ground (Y 63). The deck runs about
70 blocks from X 400 to X 470, drifting south as it goes (Z −200 to
−180).

### The Plan

1. **Scout both lips.** Walk the ravine edge at (400, 70, −200) and find
   the matching ledge at (470, 70, −180). Mark both with torches.
2. **Build the anchor.** At the west lip, lay a cobblestone pad 4×4 so
   the bridge has a solid footing.
3. **Push the deck.** Walk out from the pad, placing planks in pairs —
   two wide, one block of air on either side. Check the ravine floor
   below: it is a long way down. Do not look too long.
4. **Fence as you go.** After every two plank pairs, place fence along
   both edges. It feels slow. It is what keeps you alive.
5. **Light the way.** Every 8 blocks, a torch on the fence — 16 in all.
   The God-Split will glow like a river of fireflies.
6. **Reach the far pad.** Build a matching cobblestone pad on the east
   lip at (470, 70, −180). The deck now spans lip to lip.
7. **Cross it.** Walk the full length, west to east. Do not sprint.
   Do not jump. The bridge is yours; walk it like you own it.

### Success Checklist

- [ ] Deck 2 blocks wide, no gaps anywhere along the span
- [ ] Fence on both sides for the full length
- [ ] 16 torches placed at intervals
- [ ] Anchor pads on both lips
- [ ] Crossed the ravine safely, no falls, no deaths

### Missionary Note

*The bridge is the sixth lesson: obstacles are invitations. The Old
Builders looked at the God-Split and saw the end of their road; they
turned back, and their eastern claims were lost. The missionary looks at
a chasm and sees a path that does not exist yet — and then builds it.
Every block you place over the void is a refusal to be stopped.*

---

## MISSION 9 — THE GATE TO EMBER

**Difficulty: Normal**

### Mission Briefing

Five hundred blocks east and four hundred south, the air changes. The
trees thin, the grass yellows, and the ground feels hot underfoot. The
Old Builders' maps mark this place with a single word: EMBER. This is
where the world's second layer begins — the Nether, a dimension of fire
and ash. The missionary does not fear it; the missionary gates into it,
claims a foothold, and comes back with proof.

### Objective

Build and light a **Nether portal** at the mission site, enter the
Nether, build a **5×5×4 obsidian-and-cobble bunker** at the Nether
landing point, and return to the Overworld with **16 netherrack and
4 glowstone**.
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Portal frame (Overworld) | 500 | 64 | −400 |
| Portal arrival (Nether) | 62 | 64 | −50 |
| Nether bunker corner | 60 | 64 | −52 |
| Nether bunker corner | 64 | 64 | −48 |

*(Nether coordinates are roughly the Overworld's divided by 8:
500 ÷ 8 ≈ 62, −400 ÷ 8 = −50.)*

### The Plan

1. **Gather obsidian.** Find a lava pool and pour water over it — or
   mine the obsidian you find with the diamond pickaxe. You need 10
   blocks.
2. **Frame the gate.** At (500, 64, −400), build the portal frame:
   4 wide × 5 tall (the minimum size), 14 obsidian total. The opening
   must be exactly 4×5 — 3 wide × 4 tall inside.
3. **Strike the light.** Use the flint and steel on the bottom-inside
   block. The purple veil rises. The Gate to Ember is open.
4. **Step through.** When you arrive, you are at roughly (62, 64, −50).
   Do not wander. The Nether rewards the prepared and devours the
   curious.
5. **Claim the landing.** Immediately build the bunker: a 5×5 floor,
   walls 4 high, cobblestone roof — enclosing the portal. Cobblestone
   survives ghast fire; wood does not. Torch the inside.
6. **Gather proof.** With your iron sword ready, collect 16 netherrack
   (the red rock is everywhere underfoot) and 4 glowstone (the yellow
   glowing clusters in the ceiling). Watch for the piglin caravans —
   they are not enemies unless you open their chests. The ghasts are
   enemies. Always.
7. **Return.** Step back through the portal. The Overworld at
   (500, 64, −400) has never looked so green.

### Success Checklist

- [ ] Portal frame 14 obsidian, lit and functional
- [ ] Bunker built around the Nether landing, fully enclosed
- [ ] 16 netherrack collected
- [ ] 4 glowstone collected
- [ ] Returned to the Overworld alive, portal still lit

### Missionary Note

*The Nether is the seventh lesson: there are worlds within worlds, and
none of them are empty. The Old Builders' maps stopped at the edge of
their known ground, and so did they. The missionary crosses edges.
Fear is a fine counselor and a terrible king — take it with you, but
never let it give the orders.*

---

## MISSION 10 — THE REDSTONE RIVER

**Difficulty: Normal**

### Mission Briefing

The Old Builders left one gift behind that they did not understand:
redstone — dust that carries a pulse, a mineral nervous system sleeping
in the earth. They used it for trinkets and threw the rest away. The
missionary knows better. Redstone is obedience, made physical. This
mission builds the Redstone River: a line of lamps that answers a single
lever, sixty blocks from end to end.

### Objective

Collect **64 redstone dust**, then build a line of **8 redstone lamps**
from (620, 63, 300) to (680, 63, 300), wired with **4 repeaters**, and
light all 8 lamps with **one lever**.

### Supplies

| Item | Quantity |
|---|---|
| Redstone dust | 64 (mined) |
| Redstone lamps | 8 |
| Glowstone | 8 |
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Lamp line start | 620 | 63 | 300 |
| Lamp positions | 620, 628, 636, 644, 652, 660, 668, 676 | 63 | 300 |
| Repeater positions | 628, 644, 660, 676 | 63 | 300 |
| Master lever | 620 | 63 | 301 |

Eight lamps, spaced 8 blocks apart, from X 620 to X 676. Repeaters boost
the signal at 16-block intervals. The lever sits at (620, 63, 301), one
block off the line.

### The Plan

1. **Mine the dust.** Redstone lives at Y 5–15. Branch-mine fresh ground
   near your strongroom until you have 64 redstone dust. You will also
   need it for the repeaters — budget 4 dust for those.
2. **Craft the lamps.** 8 glowstone from Mission 9 + 32 redstone dust
   = 8 redstone lamps.
3. **Lay the line.** Place the lamps in a straight row at the mission
   coordinates. The line runs east from X 620.
4. **Wire it.** On the ground beside the lamps, lay redstone dust from
   lamp to lamp. Redstone carries a signal 15 blocks before it fades —
   so at X 628, 644, 660, and 676, place a repeater facing along the
   line to refresh the pulse.
5. **The lever.** Place the lever at (620, 63, 301), attached to the
   block next to the first lamp. Flip it.
6. **Watch the river light.** The pulse runs east, lamp after lamp,
   repeater after repeater: 620, 628, 636, 644, 652, 660, 668, 676 —
   eight points of light answering one finger.
7. **Redstone torches.** Place the 16 redstone torches along the back
   side of the line as indicators — they glow only while the signal is
   off, so you can read the river's health at a glance.

### Success Checklist

- [ ] 64 redstone dust mined
- [ ] 8 lamps placed at the mission coordinates
- [ ] 4 repeaters placed at the 16-block intervals
- [ ] One lever lights all 8 lamps
- [ ] Signal runs end to end without a break

### Missionary Note

*Redstone is the eighth lesson, and the strangest: the world obeys. Not
through prayer or force, but through understanding. The Old Builders had
this power in their hands and used it for toys. The missionary uses it
for reach — a single hand, a hundred blocks away, doing the work of ten.
Master the rules of the world, and the world becomes your tool.*

---

# TIER III — HARD

*The final five missions cross the world's true frontiers: the stronghold
under the hills, the End beyond the sky, the sunken palace, the heights
above the clouds, and finally — the heart of it all. These missions will
test everything the first ten taught you. Bring your best gear. Bring
your patience. Bring your faith in the work.*

---

## MISSION 11 — THE STRONGHOLD HUNT

**Difficulty: Hard**

### Mission Briefing

The Old Builders' greatest secret was not a building — it was a door.
Somewhere beneath the eastern hills lies the stronghold, a buried
fortress of stone and silverfish, and at its heart, a portal that no
living builder has ever used. The way to find it is written in the
world's own language: the Eye of Ender, which always flies toward the
door. This mission is a hunt.

### Objective

Craft **12 Eyes of Ender**, track the stronghold from (700, 64, 100),
enter it at **(812, 34, 213)**, and clear and light its library.
**24 bookshelves** must survive intact.
...
| Torches | 64 |
| Cooked food | 32 |
| Iron armor (full set) | 1 set |

### Coordinates

| Landmark | X | Y | Z |
|---|---|---|---|
| Hunt start | 700 | 64 | 100 |
| Stronghold staircase | 812 | 34 | 213 |
| Library floor (southwest corner) | 806 | 32 | 209 |
| Library floor (northeast corner) | 817 | 32 | 216 |
| Portal room (next mission) | 812 | 30 | 213 |

The stronghold burrows through the hills at Y 30–40. The library sits
12 blocks wide and 8 deep at Y 32, its bookshelves lining the walls.

### The Plan

1. **Craft the eyes.** 12 ender pearls + 12 blaze powder = 12 Eyes of
   Ender. (Blaze powder means a Nether trip for blaze rods — use your
   Gate to Ember bunker as your base of operations.)
2. **Throw and follow.** Stand at (700, 64, 100). Throw an Eye of Ender;
   it floats toward the stronghold. Walk in that direction. When it
   drops to the ground, pick it up, walk past it, throw again. Repeat.
3. **Watch it sink.** The eyes will eventually fly *down* into the
   hillside and shatter. Dig where they vanish. You are over the
   stronghold.
4. **Find the stairs.** Descend until you hit the stone-brick corridors
   of the stronghold around Y 34. Locate the staircase at (812, 34, 213).
5. **Clear the library.** Fight the silverfish in swarms — they burst
   from mined stone brick, so break blocks with your sword ready. The
   library is the largest room: high ceiling, double-decker bookshelves,
   a ladder, and a chest with loot.
6. **Light and count.** Torch every corner and aisle — 64 torches is
   enough for the library and the corridors around it. Count the
   bookshelves: 24 must remain. Do not break them. They are the
   stronghold's last library, and they are older than the Old Builders
   themselves.
7. **Report the door.** In the room beneath the library, at (812, 30,
   213), you will find the portal frame — the End Portal, unlit, waiting.
   Leave it for Mission 12. Your mission here is done.

### Success Checklist

- [ ] 12 Eyes of Ender crafted and used
- [ ] Stronghold entered at (812, 34, 213)
- [ ] Library cleared of mobs and fully lit
- [ ] 24 bookshelves intact
- [ ] End Portal frame located and marked

### Missionary Note

*The hunt is the ninth lesson: some doors cannot be built — they must be
found. The Old Builders bricked over their greatest gate and forgot it,
the way people bury what they fear to finish. The Eye of Ender does not
lie; it flies toward what was hidden. Follow the truth of the world,
even when it leads you underground.*
...
The portal at (812, 30, 213) opens onto the End: a black sky, an island
of pale stone, and the Ender Dragon — the world's oldest tyrant, the
reason the Old Builders sealed the door and fled. The missionary's
commission does not stop at the edge of the map. It stops only when the
tyrant falls. This is the mission the whole book has been building
toward. Arm yourself, step through, and end the End.

### Objective

Activate the End Portal at the stronghold, enter the End, **defeat the
Ender Dragon**, and return through the gateway with the **dragon egg**.

### Supplies

| Item | Quantity |
|---|---|
| Eyes of Ender | 12 (for the portal) |
| Bow | 1 (enchanted with Power if you have it) |
| Arrows | 128 |
| Golden apples | 8 |
| Water buckets | 3 |
| End stone (bridging) | 64 |
| Diamond pickaxe | 1 |
| Slow Falling potions | 3 |
| Cooked food | 32 |
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Portal room (Overworld) | 812 | 30 | 213 |
| Arrival platform (End) | 100 | 50 | 0 |
| Central pillar ring | 0–20 from center | 65–80 | 0 |
| Dragon egg (after victory) | 0 | 65 | 0 |
| Return gateway | 100 | 50 | 0 |

### The Plan

1. **Fill the frame.** Place an Eye of Ender in each of the 12 frame
   blocks around the portal at (812, 30, 213). The green fire lights.
   Step back, then step through.
2. **Arrive.** You stand on the obsidian platform at (100, 50, 0). The
   dragon circles the island's central spire. Take a breath. This is
   the moment the book promised.
3. **Destroy the crystals.** The dragon cannot die while the end
   crystals heal it. The crystals sit on obsidian pillars ringing the
   island. Build up each pillar with end stone, break the crystal with
   your pickaxe or a well-aimed arrow, and — critically — **break the
   iron bars beneath it** or the dragon will re-heal. Protect yourself:
   the dragon's fire breath and wing buffet are the real weapons.
   Golden apples and the water buckets (for quick drops) are your
   insurance.
4. **Drink, then bridge.** When the crystals are gone, the dragon can
   be hurt. Drink a Slow Falling potion before long descents. Bridge
   across the void with end stone to reach the dragon as it perches on
   the central spire at the ring's heart.
5. **Bring it down.** Arrow after arrow, the dragon spirals lower. When
   it perches on the spire, charge. Its health bar drains. Keep firing.
6. **Collect the egg.** The dragon dies in a shower of light — and on
   the spire at (0, 65, 0) rests the dragon egg, black as the old sky.
   Mine the block beneath it carefully so it falls to a torch and
   becomes an item. It is yours now.
7. **Return.** The gateway at (100, 50, 0) opens. Step through, and the
   Overworld rises around you: green, safe, and *free*. The tyrant of
   the End has fallen, and the missionary who fell it stands in the
   light.

### Success Checklist

- [ ] Portal activated with 12 eyes
- [ ] All end crystals destroyed
- [ ] Ender Dragon defeated
- [ ] Dragon egg collected at (0, 65, 0)
- [ ] Returned alive through the gateway at (100, 50, 0)

### Missionary Note

*The End is the tenth lesson, and it is the heart of the whole book:
the thing that overtook the world is not a mob, not a curse, not a
dragon. It is the fear that made the Old Builders seal the door instead
of walking through it. The dragon is real, and it is killable. Nothing
that casts a shadow is stronger than the one who walks toward it with
light in hand.*

---

## MISSION 13 — THE SUNKEN PALACE

**Difficulty: Hard**

### Mission Briefing

The ocean east of the ravine holds a palace the Old Builders never
finished building and never dared to enter: a monument of dark
prismarine, guarded by the elder guardians — ancient fish of pure
malevolence that curse all who approach. Beneath it lies a fortune:
sponges, gold, and the deep-sea crystal called prismarine, which
glows with the light of the sea itself. The missionary does not
loot ruins. The missionary *clears* them.

### Objective

Enter the ocean monument at **(950, 62, −500)**, defeat the **3 elder
guardians**, mine **64 prismarine** and **16 sponge**, and build an
**active conduit** at (950, 60, −500).
...
|---|---|
| Conduit | 1 |
| Prismarine | 42 (for the conduit frame) |
| Water Breathing potions | 3 |
| Doors | 16 (air pockets under water) |
| Glowstone | 16 |
| Iron pickaxe | 2 |
| Cooked food | 32 |
...
| Landmark | X | Y | Z |
|---|---|---|---|
| Monument entrance | 950 | 62 | −500 |
| Monument bounds | 940–960 | 58–80 | −510 to −490 |
| Elder guardian (west wing) | 943 | 62 | −505 |
| Elder guardian (east wing) | 957 | 62 | −495 |
| Elder guardian (top) | 950 | 78 | −500 |
| Conduit site | 950 | 60 | −500 |

The monument is 20 blocks square, rising from Y 58 to Y 80 — an
underwater mountain of dark stone. The conduit goes at its heart, at
the entrance level.

### The Plan

1. **Prepare for the deep.** Drink a Water Breathing potion before you
   swim in. Bring all three — the mission is long.
2. **Enter.** At (950, 62, −500) you find the entrance tunnel. Place
   doors as air pockets along the way — doors hold air under water, and
   air is where you catch your breath.
3. **The elders.** Three elder guardians haunt the monument: one in the
   west wing (943, 62, −505), one in the east wing (957, 62, −495),
   one in the top chamber (950, 78, −500). Each curses you with mining
   fatigue. Kill them with your pickaxe — they are slow and clumsy
   outside water's protection.
4. **Strip the palace.** Mine prismarine from the walls and floors —
   you need 64. The blocks cut slowly under water; the conduit will
   fix that. Break the sea lanterns for extra light and place your
   glowstone in the corridors.
5. **The sponge room.** Find the sponge rooms (they are the rooms whose
   floors are sand, not prismarine). Break the sponges — 16 of them.
   They will be priceless when you build underwater again.
6. **Build the conduit.** At (950, 60, −500), build the full-power
   frame: three 5×5 rings of prismarine — one horizontal, two vertical
   — crossing through the conduit block at the center. 42 prismarine
   blocks total. When the frame is complete, the conduit activates —
   and suddenly, within its range, you can breathe, you can see, and
   you can mine like the sea itself is on your side.
7. **Light the heart.** Place the remaining glowstone around the conduit
   so the heart of the palace glows like a lantern in a cathedral.

### Success Checklist

- [ ] All 3 elder guardians defeated
- [ ] 64 prismarine mined
- [ ] 16 sponge collected
- [ ] Conduit active at (950, 60, −500) with full frame
- [ ] Monument fully lit, no guardians remaining

### Missionary Note

*The sunken palace is the eleventh lesson: what is deepest is often
what is most afraid of light. The elders did not defend the monument —
they hid in it, and their curse was only fear made visible. The
conduit, a heart of light built from the sea's own stone, turns their
fortress into a lantern. Bring light to the deepest place, and the
deepest place will serve you.*

---

## MISSION 14 — THE FLOATING CITY

**Difficulty: Hard**

### Mission Briefing

The world below is nearly yours. The fields are lit, the strongroom is
full, the dragon is dead, and the sea glows with your conduit. But the
missionary's work is not finished while the sky itself remains
unclaimed. Twelve hundred blocks east and eight hundred south, the
plains rise into a mesa — and above the mesa, nothing but air. The
Old Builders looked up and saw weather. You will look up and see
**the site**.

### Objective

Build a **30×30 floating island** at (1200, 150, 800) with **4
buildings**, a **wheat farm**, and a **waterfall access column** from
the ground at (1200, 63, 800). The island must be livable: lit,
fenced, and reachable without taking fall damage.
...
| Ladders | 96 |
| Cobblestone | 128 |
| Scaffolding (bamboo or planks) | 128 |

### Coordinates

| Landmark | X | Y | Z |
|---|---|---|---|
| Island floor (southwest corner) | 1185 | 150 | 785 |
| Island floor (northeast corner) | 1215 | 150 | 815 |
| Waterfall column | 1200 | 63 → 150 | 800 |
| Building 1 (northwest) | 1188 | 151 | 788 |
| Building 2 (northeast) | 1208 | 151 | 788 |
| Building 3 (southwest) | 1188 | 151 | 812 |
| Building 4 (southeast) | 1208 | 151 | 812 |
| Farm | 1194–1206 | 151 | 794–806 |

The island floats at Y 150, 87 blocks above the mesa floor. Each
building is 5×5. The farm is 12×12 at the island's center.

### The Plan

1. **The pillar.** At (1200, 63, 800), build straight up to Y 150.
   Scaffold as you go. This is the spine of the Floating City.
2. **The platform.** From the pillar top, build the 30×30 floor:
   X 1185–1215, Z 785–815. Dirt for the farm zone, planks everywhere
   else.
3. **The waterfall.** At the pillar, make the climb permanent: place
   water at the top so it falls all the way down, and ring the column
   with ladders for a dry route. No more scaffolding — the city must
   stand on its own.
4. **Four buildings.** Raise a 5×5 house in each quadrant at the mission
   coordinates: plank walls, glass windows, plank roofs, one door each.
   Each house gets a bed, a chest, and a crafting table. Four corners,
   four homes, one city.
5. **The farm.** Till the center 12×12, water it from the bucket, plant
   32 seeds. The Floating City eats what it grows.
6. **Light and rail.** Lanterns every 8 blocks around the island edge —
   64 total. Ring the edge with glass panels so nothing and no one
   walks off in the night.
7. **Test the descent.** Jump from the edge? No — the missionary tests
   the waterfall. Climb down the ladders, walk back, and look up. The
   city hangs in the sky like a promise kept.

### Success Checklist

- [ ] Island 30×30 at (1185, 150, 785) to (1215, 150, 815)
- [ ] 4 buildings built and furnished
- [ ] Farm planted and harvested once
- [ ] Waterfall and ladder access both functional
- [ ] 64 lanterns placed, glass railing complete

### Missionary Note

*The Floating City is the twelfth lesson: the world is not finished,
and neither are you. The Old Builders built where the ground allowed
and called it fate. The missionary builds where the work demands, and
calls it vision. Height is not an obstacle — it is an opportunity.
Claim the sky, and the sky will hold you.*

---

## MISSION 15 — THE BEACON OF OVERTAKING

**Difficulty: Hard**

### Mission Briefing

Return to where you began. Spawn at (0, 63, 0) — the first plot, the
first foundation, the place where the reclamation started. The world
has changed since you stood here with nothing. The house stands, the
farm feeds, the road glows, the tower watches, the strongroom holds,
the bridge spans, the gate burns, the river runs, the stronghold is
open, the dragon is dead, the sea is lit, and a city hangs in the sky.
One thing is missing: a monument that tells the world *why*. This
final mission builds the Beacon of Overtaking — a pyramid, a beam of
light, and a wall of stone, at the very heart of the world.

### Objective

Build a **4-layer beacon pyramid** (164 mineral blocks) at
(−4, 63, −4) to (4, 63, 4), activate the **beacon**, surround the
site with a **50×50 stone wall**, and raise a **banner** over the gate.
...
|---|---|
| Beacon | 1 |
| Mineral blocks (iron, gold, emerald, or diamond — any mix) | 164 |
| Cobblestone | 512 |
| Quartz (or white blocks for the cap) | 128 |
| Banner | 1 |
| Torches | 64 |
| Iron ingots | 16 (to feed the beacon) |

### Coordinates

| Landmark | X | Y | Z |
|---|---|---|---|
| Pyramid base (southwest corner) | −4 | 63 | −4 |
| Pyramid base (northeast corner) | 4 | 63 | 4 |
| Layer 2 (7×7) | −3 to 3 | 64 | −3 to 3 |
| Layer 3 (5×5) | −2 to 2 | 65 | −2 to 2 |
| Layer 4 (3×3) | −1 to 1 | 66 | −1 to 1 |
| Beacon | 0 | 67 | 0 |
| Wall corner (southwest) | −25 | 63 | −25 |
| Wall corner (northeast) | 24 | 63 | 24 |
| Gate (west wall) | −25 | 63–67 | 0 |
| Banner | −25 | 68 | 0 |

The pyramid: 9×9 at Y 63 (81 blocks), 7×7 at Y 64 (49), 5×5 at Y 65
(25), 3×3 at Y 66 (9) — 164 blocks total, crowned by the beacon at
(0, 67, 0).

### The Plan

1. **Gather the wealth.** You need 164 mineral blocks. Iron is the
   workhorse (your Ironworks can supply it); gold, emerald, and
   diamond from your travels fill the rest. The beacon does not care
   what the pyramid is made of — only that it stands.
2. **Lay the base.** At (0, 63, 0), build the 9×9 layer: X −4 to 4,
   Z −4 to 4.
3. **Raise the pyramid.** Layer 2 (7×7) at Y 64, centered. Layer 3
   (5×5) at Y 65. Layer 4 (3×3) at Y 66. Each layer centered on
   (0, ?, 0). Check the math: 81 + 49 + 25 + 9 = 164.
4. **Crown it.** Place the beacon on the single block at (0, 67, 0).
   Feed it the 16 iron ingots. The beam erupts — a column of light
   that pierces the sky and can be seen from any corner of the world.
   Stand in its glow and select your power: Speed and Haste are the
   missionary's gifts.
5. **The wall.** From (−25, 63, −25) to (24, 63, 24), raise a 2-high
   cobblestone wall around the beacon site: 50 blocks on each side,
   four corners. Leave a gate gap in the west wall at (−25, 63–67, 0)
   — a doorway, not a barricade. The light is not for keeping people
   out. It is for calling them home.
6. **The banner.** Cap the gate at (−25, 68, 0) with the banner — your
   colors, your mark. The reclamation has a flag now.
7. **Light the ramparts.** Torches along the wall every 8 blocks — 64
   total. The wall glows like a crown.
8. **The view.** Climb to the top of your own house at (24, 68, 12).
   Look west: the beacon's beam rises from the heart of the world.
   Walk the Lantern Road one last time. Count the landmarks — every
   one of them, yours. The world is no longer overtaken. It is
   *overtaken by light*.

### Success Checklist

- [ ] Pyramid built to exact spec: 81 + 49 + 25 + 9 = 164 blocks
- [ ] Beacon active, beam visible from the ground
- [ ] Wall 50×50, 2 blocks high, with gate
- [ ] Banner raised over the gate
- [ ] 64 torches on the ramparts
- [ ] View from (0, 150, 0): the world, lit, claimed, and free

### Missionary Note

*This is the last lesson, and it is the whole book in one beam of
light: you do not reclaim the world by conquering it. You reclaim it by
lighting it. The Old Builders built walls to keep the dark out and the
dark simply waited. You built a light that makes the dark irrelevant.
Go where the mission takes you. Build what the work demands. Light
what you build. And when the night comes — and it will come — let it
find a world that is already overtaken.*

*By the light. By the work. By the world you took back.*

*Mission complete.*

---

## EPILOGUE — THE OVERTAKING

The beacon burns. The world is yours.

Fifteen missions, three tiers, one world reclaimed. You began with
nothing but a compass and a commission, and you end with a kingdom of
light: a home at (24, 64, 12), a farm at (−45, 63, 80), a road of
torches from spawn to (100, 64, 100), a tower at (−120, 64, −40), a
mine at (50, 16, −70), a strongroom at (200, 30, 300), an Ironworks
at (350, 64, 100), a bridge across the God-Split, a gate to the Nether
at (500, 64, −400), a river of redstone at (620–676, 63, 300), a
stronghold found at (812, 34, 213), an End conquered, a sea made
light, a city in the sky, and a beacon at the heart of it all.

The world was overtaken once. Now it is overtaken by something better.

The book is finished. The mission is not. The world beyond the beacon
still holds dark corners, unbuilt bridges, unfound strongholds. That is
not a tragedy. That is the work. The missionary's commission never
expires — it just changes shape.

*Go, and take the next world back.*
...
## MISSION 23 — THE SONG THAT DROWNED

**Difficulty: Nightmare**

### Mission Briefing

The Ember Crown sleeps in its tomb at (3300, 34, −3100), and for eight days the sea over it has been still. You know better than to trust a still sea. The sea is not a road or a stronghold; it is a memory, and the shadow has always been better at remembering than you. It remembered that you drowned its crown. It remembered the water that held it, the glowstone that ringed it, the obsidian that sealed it. And then it did the only thing it has never done: it went where the water had already won.

Far past the tomb, past the drowned spar and the last charted mile, the Old Builders sank their first cathedral — a prismarine choir they raised before they raised the Beacon, a house where they sang the sea calm in the first days of the world. They called it the chapel at the world's edge. The shadow calls it home. It climbed the fault your tomb-breaking opened in the deep, swam up through the breach, and poured itself into that drowned choir like breath into a corpse. The cathedral's great organ — a Heart of the Sea set in a conduit frame of prismarine and sea lanterns — no longer sings the sea calm. It sings the sea forward.

Field report, missionary. Every drowned within a thousand blocks is marching. They come up the rivers at night, west toward the Redstone River at (620–676, 63, 300), toward the farm at (−45, 63, 80), toward the Lantern Road's eastern lamps. When the tide reaches the lamp line, the water follows the drowned, and when the water crosses the farmland, it will find the breach above the Ember Crown's tomb at (3300, 34, −3100) and raise its king again — a risen sun of dark, crowned twice, wearing your own seal ring as a hat. The clock is the third dawn. The shadow has stopped trying to outlight you. It is trying to outremember you.

And the chapel has teeth. The shadow crowned its own elder guardian there — the Brine Prelate, coral-crowned, sleeping in the nave while the heart sings its backwards hymn. Its presence inflicts the Fatigue of the Deep on every pick that bears within its gloom, and while the heart sings, the Prelate cannot die. But you did not come to fight what you cannot kill. You came to build what the shadow cannot hear. The cathedral is half-buried in old song and older glass — its broken conduit frame scattered through the ruin, its four side chapels sealed behind archaeology the shadow has never understood. Suspicious gravel holds the Echo Seals. A brush, not a sword, opens the altar. The dark can learn to build towers and crowns; it cannot learn to be patient. That is still yours.

### Objective

**Dive to the drowned cathedral at (4800, 34, −4300), brush the four Echo Seals from the suspicious gravel of its side chapels, take the Heart of the Sea from the High Altar, rebuild the conduit frame of 42 prismarine-family blocks and 16 sea lanterns around the heart at (4800, 35, −4300), slay the Brine Prelate within the lit current, fit the Brine Glass into the belfry lantern at (4800, 46, −4300), and return to the Beacon of Overtaking at (0, 67, 0) as the drowned tide stands down.**
...
| Netherite sword (Looting III) | 1 |
| Shield | 1 |
| Trident (Loyalty III) | 1 |
| Diamond pickaxe (Efficiency V) | 1 |
| Brush | 1 |
| Diamond chestplate | 1 |
| Diamond boots (Depth Strider III) | 1 |
| Nautilus shells | 8 |
| Splash potion of Water Breathing | 3 |
| Splash potion of Healing II | 2 |
| Golden apple | 2 |
| Torches | 8 |
| Cooked beef | 8 |
| Prismarine / prismarine bricks / dark prismarine (mined from the ruined frame) | 42 |
| Sea lanterns (reclaimed from the ruined frame) | 16 |

The nautilus shells are the whole lung of the first half: eight shells to seat the heart, sealed in your pack until the altar opens. The prismarine and sea lanterns are not carried to the chapel — they are the chapel. The ruin holds exactly 58 usable blocks of its broken frame. Count them as you mine them. If you break one decorative block, the count fails and no conduit will ever burn here again. Brush before you mine; mine before you wake the nave.

### Coordinates

| Landmark | X | Y | Z |
|---|---|---|---|
| Mangrove coast trailhead | 4500 | 63 | −4100 |
| Surface marker / drowned spar | 4800 | 63 | −4300 |
| Porch air pocket | 4800 | 35 | −4370 |
| Chapel NW — Echo Seal | 4784 | 34 | −4316 |
| Chapel NE — Echo Seal | 4816 | 34 | −4316 |
| Chapel SW — Echo Seal | 4784 | 34 | −4284 |
| Chapel SE — Echo Seal | 4816 | 34 | −4284 |
| High Altar / Heart of the Sea | 4800 | 34 | −4300 |
| Conduit heart (placed) | 4800 | 35 | −4300 |
| Brine Prelate's nave | 4800 | 32 | −4360 |
| Belfry / Brine Glass socket | 4800 | 46 | −4300 |
| Beacon crown (return) | 0 | 67 | 0 |

The chapel stands at the far eastern edge of the drowned world, 6,400 blocks from spawn — the farthest site ever claimed. The mangrove coast thins to open sea at (4500, 63, −4100); a single dead spar marks the chapel's position above the waves. Beneath the surface, the cathedral opens south to north: the porch air pocket, the four side chapels, the nave where the Prelate sleeps, and the High Altar rising at the crossing, crowned by a hollow spire that reaches to the open air at Y = 63. The conduit pattern is carved into the altar floor in copper — the Old Builders left you instructions. Read them.

### The Plan

1. **March the tidal road.** At first light, count your supplies twice at spawn: 8 shells, 3 potions, 1 brush, and nothing wasted. Do not follow the rivers — the drowned are already pulling west up the current, and a riverbank is a road made of enemies. Follow the high ridgeline south-southeast from the Lantern Road, keeping the Ember Crown's tomb well north of your line. Sprint between breaths. The mangrove coast at (4500, 63, −4100) is 4,500 blocks of open ground, and the third dawn is the only clock that matters. Plant 2 torches at the trailhead so your return has eyes.

2. **Read the drowned cathedral.** Drink the first water breathing potion and swim east to the dead spar at (4800, 63, −4300). Dive. The cathedral takes shape in the gloom: prismarine walls, copper gutters, a spire the sea has grown moss around. Enter through the southern porch and surface in the air pocket at (4800, 35, −4370). Light 4 torches on its walls. From the pocket, map the four side chapels by their coral naves — northwest, northeast, southwest, southeast — and note where the broken frame blocks sit in the walls. The Prelate sleeps in the nave at (4800, 32, −4360), its eye closed, its crown of coral still. It does not know your name yet. Keep it that way.

3. **Scavenge the frame.** Work the ruins before you wake anything. Mine exactly 42 prismarine-family blocks and 16 sea lanterns from the broken frame — the walls and floors hold the count, and the count is sacred. Break no decorative block, no moss, no coral you did not mark. The Fatigue of the Deep thickens the water as you near the nave, so harvest the chapels first, farthest first, and keep the tally on your fingers: 42 and 16, 42 and 16. When the count is full, carry it to the altar crossing at (4800, 34, −4300). The carved pattern on the floor shows every seat. Read it. Memorize it. Then set the blocks down in neat stacks at the altar's edge — 26 for the shell around the heart, 16 for the wide ring, 16 lanterns for the ring's faces.

4. **Brush the first two seals.** North chapels first. Kneel at the coral pillar in the northwest chapel at (4784, 34, −4316); beneath the coral's root, a block of suspicious gravel waits, older than the drowning. Take out the brush and work it — one stroke, two, three. Brushing is slow, and slowness is a sound in the water. Drowned will drift in from the nave to answer every scrape of the brush. Between strokes, stand, throw the trident, call it home, and go back to brushing. On the tenth stroke the gravel crumbles and the first Echo Seal falls into your hand — a shard of copper-glazed clay, singing the old song forward. Repeat at the northeast chapel (4816, 34, −4316). Seal 2 of 4. The drowned are thickening. The Prelate's eye has not yet opened.

5. **Brush the last two seals.** Southwest chapel at (4784, 34, −4284), then southeast at (4816, 34, −4284). The drowned come in pairs now; throw the trident, catch it, throw again. Drink the second water breathing potion. Brush through the fear — patience is the weapon, and the brush is the blade. When the fourth seal falls, the cathedral's song stutters, once, like a singer catching a breath that does not belong to it. The Prelate's eye opens in the nave. Hold still. It does not see — it sings. Do not let it hear you finish the work.

6. **Open the altar.** Carry the four Echo Seals to the High Altar at (4800, 34, −4300). Four copper sconces wait at the altar's corners, corroded green and singing the backwards hymn in your teeth. Set each seal into its sconce — northwest, northeast, southwest, southeast, in the order you earned them. The altar splits along its oldest seam, and inside, where the Old Builders set it in the first days, the Heart of the Sea rests — corrupted, turned, broadcasting the drowned song east and west. Take it. The instant your hand closes on it, the hymn stops, the water goes silent, and the Prelate rises from the nave at (4800, 32, −4360). It is coming. Build.

7. **Build the current.** Place the Heart of the Sea on the altar's crown at (4800, 35, −4300). Now build — fast, exact, while the Prelate crosses the nave. Seat the 42 prismarine blocks in the carved pattern: 26 in the three hollow shells of the cube around the heart, 16 in the wide five-by-five ring that spans the middle of the frame. Then fit the 16 sea lanterns into the ring's outer faces, two per compass point, where the copper marks shine. The last lantern seats itself. The conduit ignites — clear light blooms through the water, a ninety-block radius of cold bright singing, and the drowned at the chapel's edge burn like struck matches. The Fatigue lifts. The water is yours. Turn and face what is coming.

8. **Court the Prelate.** The Brine Prelate fills the nave — an elder guardian grown to choir size, coral-crowned, its eye a green wound burning with everything the shadow fed it. Outside the conduit's light it cannot die; inside the light its crown blackens and its beams bend. Fight in the lit water: strafe as the beam gathers, catch its edge on the shield, answer with the trident — throw, recall, throw. When its eye opens wide to fire the killing beam, close in under it and strike with the netherite sword. Golden apples for the beams you cannot dodge; healing potions for the ones you fail to. Its death is a crack of glass and a sudden silence. The Brine Glass drops from its broken crown — a shard of the first light, caged in coral, still singing. Take it.

9. **Ring the belfry.** Climb the spire's inner shaft from the altar crossing to the belfry at (4800, 46, −4300). The copper lantern frame hangs open at the spire's crown, and the sea pours through it. Fit the Brine Glass into the socket. It catches the conduit's light below and throws it outward — the backwards hymn tears, inverts, and becomes the Song. Every drowned within a thousand blocks stops mid-breaststroke and sinks. The water over the Ember Crown's tomb at (3300, 34, −3100) goes still. The tide un-marches. Swim up through the belfry's mouth to open air at (4800, 63, −4300) as the third dawn breaks — so thin a margin it scars you.

10. **Rise to the dawn.** Surface at the dead spar. The drowned are standing down along every river, drifting with the current instead of against it. Swim west to the mangrove coast at (4500, 63, −4100), reclaim your 2 torches, and ride the high ridgeline home. The rivers are silent; the lamp line holds. Reach the Beacon at (0, 63, 0), climb to the crown at (0, 67, 0), and stand in the light. East, beyond the farmland and the drowned spar, the sea is calm — not conquered, not silent, but singing the old way again. The shadow outremembered you and you outbuilt it. The Song that drowned is the Song that holds.

### Success Checklist

- [ ] Kit counted at spawn and carried intact: 8 nautilus shells, 3 water breathing potions, 1 brush, 2 torches at the trailhead.
- [ ] Exactly 42 prismarine-family blocks and 16 sea lanterns scavenged from the ruined frame — no decorative block broken, count held.
- [ ] Four Echo Seals brushed and recovered: NW (4784, 34, −4316), NE (4816, 34, −4316), SW (4784, 34, −4284), SE (4816, 34, −4284).
- [ ] High Altar opened at (4800, 34, −4300); the Heart of the Sea taken; the Prelate raised.
- [ ] Conduit frame built to the carved pattern: 42 prismarine + 16 sea lanterns around the heart at (4800, 35, −4300); the current burns.
- [ ] Brine Prelate slain at (4800, 32, −4360) within the lit radius; the Brine Glass recovered from its crown.
- [ ] Brine Glass socketed in the belfry at (4800, 46, −4300); the hymn inverted; the drowned stand down.
- [ ] Survive the third dawn from (0, 67, 0): the eastern sea is calm — no tide, no smoke, no risen crown above the tomb.

### Missionary Note

*The shadow can learn to build towers and crowns and conduits that sing backwards. It cannot learn to be slow. It rushes everything — its raids, its hymns, its burning beacons — because it believes the world is a race, and it wants to win it. But the first light was not built in a hurry. The Old Builders brushed the dust off the world for a thousand years before they found the shape of the first song. You knelt on a chapel floor and brushed four stones of gravel while drowned came at you, and that patience is the thing the dark has never once been able to copy.*

*The conduit is the truest light you have ever built. It does not burn, it does not blind, it does not tower. It simply holds — a small cold sun that keeps the water clear, keeps the air in your lungs, keeps the Fatigue off your hands, and tells every dark thing within ninety blocks that it is no longer at home here. That is the shape of the reclamation, missionary. Not one great flame, but a place where the dark cannot sit down.*

*The sea does not forget. It carried the Old Builders' first song for a thousand years and it will carry yours now. The shadow used the sea as a memory of dread. You have made it a memory of light again. Go home up the ridge. The drowned are swimming backward, and the tide you broke is the tide that held you.*

*— Still commissioned. Still brushing the dust off the world. Still singing beneath the salt.*
...
**The order is always X, Y, Z.**

- **X:** east (+) or west (−)
- **Y:** up (+) or down (−) — your altitude
- **Z:** south (+) or north (−)

**Sea level is Y = 63.** Everything in this book measures from there.

**To find any mission site:** match X and Z first (that puts you in the
right horizontal place), then adjust Y (that puts you at the right
floor). X or Z changes mean sideways movement. Y changes mean up or
down.

**Nether rule:** Nether coordinates are roughly Overworld ÷ 8. The
portal at Overworld (500, −400) lands you at Nether (62, −50).

---

## APPENDIX B — MASTER COORDINATE TABLE

| Mission | Site | X | Y | Z |
|---|---|---|---|---|
| 1 — The First Foundation | House plot | 24 | 64 | 12 |
| 2 — The Bread Basket | Farm field | −45 | 63 | 80 |
| 3 — The Lantern Road | Path end / tower | 100 | 64 | 100 |
| 4 — The Watchtower | Tower base | −120 | 64 | −40 |
| 5 — The First Descent | Shaft mouth | 50 | 63 | −70 |
| 6 — The Underground Strongroom | Room floor | 200 | 30 | 300 |
| 7 — The Ironworks | Furnace row | 350 | 64 | 100 |
| 8 — The Chasm Bridge | West lip | 400 | 70 | −200 |
| 9 — The Gate to Ember | Portal (Overworld) | 500 | 64 | −400 |
| 9 — The Gate to Ember | Bunker (Nether) | 62 | 64 | −50 |
| 10 — The Redstone River | Lamp line start | 620 | 63 | 300 |
| 11 — The Stronghold Hunt | Stronghold library | 812 | 34 | 213 |
| 12 — The End | Portal room | 812 | 30 | 213 |
| 13 — The Sunken Palace | Monument entrance | 950 | 62 | −500 |
| 14 — The Floating City | Island floor | 1200 | 150 | 800 |
| 15 — The Beacon of Overtaking | Beacon | 0 | 67 | 0 |

---

## APPENDIX C — THE SUPPLIES LEDGER

The full tally of what the reclamation demands. Gather as you go;
the ledger is the missionary's budget.
...
| Coal | 112 |
| Sticks | 48 |
| Oak logs / planks | 64 logs, 736 planks |
| Cobblestone | 1,376 |
| Glass | 152 |
| Fence / fence gates | 236 + 1 gate |
| Ladders | 224 |
| Chests | 20 |
| Furnaces | 16 |
| Crafting tables | 10 |
| Iron ingots (banked) | 112 |
| Iron ore (mined) | 160 |
| Redstone dust | 64 |
| Glowstone | 12 |
| Obsidian | 14 |
...
*(Quantities are minimums. The missionary who gathers more never
regrets it.)*
...
- **Beacon** — a block that projects a beam of light into the sky when
  placed atop a mineral pyramid; grants powers to those in its glow.
- **Branch mining** — digging parallel tunnels two blocks apart to
  expose maximum ore for minimum effort.
- **Conduit** — a heart of prismarine and nautilus shell that grants
  water breathing and vision underwater when framed in prismarine.
- **Elder guardian** — the ancient, cursed fish that guard ocean
  monuments; they inflict Mining Fatigue.
- **End Crystal** — the healing crystal atop each obsidian pillar in
  the End; the dragon cannot die while they remain.
- **Eye of Ender** — crafted from ender pearl and blaze powder; flies
  toward the nearest stronghold when thrown.
- **Ender Dragon** — the tyrant of the End dimension, and the final
  boss of the mission field.
- **Ghast** — a large floating fire creature of the Nether that fires
  explosive fireballs.
- **God-Split** — the ravine crossed by the Chasm Bridge; a missionary
  landmark.
- **Hopper** — a block that moves items from one container to another;
  the heart of any automated system.
- **Lantern of the East** — the torch tower at (100, 64, 100), first
  landmark of the reclamation.
- **Nether** — the dimension of fire reached through a lit obsidian
  portal; coordinates are roughly one-eighth of the Overworld's.
- **Piglin** — a gold-loving creature of the Nether; neutral unless
  provoked.
- **Repeater** — a redstone component that refreshes and delays a
  signal, letting it travel farther than 15 blocks.
- **Silverfish** — a small mob that bursts from mined stone brick in
  strongholds; swarm with friends.
- **Spawn** — the point (0, 63, 0) where you first entered the world
  and where the reclamation began.

---

*Minecraft Overtaken — A Missionary's Guide to Reclaiming the Blocky
World. Written in the mission field, block by block.*
